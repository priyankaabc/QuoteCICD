...
namespace QuoteCalculator.Data
{
    ...
    public partial class quotesEntities : DbContext
    {
        ...
        public virtual DbSet<vw_QuoteAmount> vw_QuoteAmount { get; set; }
        ...
        public virtual ObjectResult<GetCity_Result> GetCity(string countryCode, Nullable<int> companyCode)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCity_Result>("GetCity", countryCodeParameter, companyCodeParameter);
        }
        ...
        public virtual ObjectResult<GetCityForInternationalRemoval_Result> GetCityForInternationalRemoval(string countryCode, Nullable<int> companyCode)
        {
            var countryCodeParameter = countryCode != null ?
                new ObjectParameter("CountryCode", countryCode) :
                new ObjectParameter("CountryCode", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCityForInternationalRemoval_Result>("GetCityForInternationalRemoval", countryCodeParameter, companyCodeParameter);
        }
        ...
        public virtual ObjectResult<GetCityForBaggae_Result> GetCityForBaggae(string countryCode, Nullable<int> companyCode)
        {
            var countryCodeParameter = countryCode != null ?
                new ObjectParameter("CountryCode", countryCode) :
                new ObjectParameter("CountryCode", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCityForBaggae_Result>("GetCityForBaggae", countryCodeParameter, companyCodeParameter);
        }
