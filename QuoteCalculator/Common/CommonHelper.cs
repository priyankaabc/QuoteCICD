...
namespace QuoteCalculator.Common
{
    public class CommonHelper
    {
        ...
        public static readonly Dictionary<string, object> ActionCenterColumnStyleWithCanEdit = new Dictionary<string, object> { { "align", "center" }, { "style", "text-align:center;vertical-align:middle !important;width:80px !important" }, { "width", "80px" } };

        public static readonly Dictionary<string, object> ActionCenterColumnStyleWithCanStatus = new Dictionary<string, object> { { "align", "center" }, { "style", "text-align:center;vertical-align:middle !important;width:120px !important" }, { "width", "120px" } };
        ...
        public static string GetErrorMessage(Exception ex, bool getStactRetrace = true)
        {
            try
            {
                var exepurl = context.Current.Request.Url.ToString();
                Task task = new Task(() => EmailNotification.SendMailMessage(exepurl, ex));
                task.Start();
